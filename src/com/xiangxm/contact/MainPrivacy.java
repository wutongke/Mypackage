						...
						case 4:{
							...
							.setPositiveButton("确定", new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									...
									btn_login_ok.setOnClickListener(new OnClickListener(){
										...
										public void onClick(View v) {
											if(et_account.getText().toString().equals("admin") && et_password.getText().toString().equals("admin")) {
												...
												et_password.setText("");
												loginDialog.dismiss();
												Intent intent = new Intent(MainPrivacy.this,MainPrivacy.class);
												startActivity(intent);
												
											} else {
												Toast.makeText(MainPrivacy.this, "失败", Toast.LENGTH_LONG).show();
											}
										}
									...
									if(loginDialog == null) {
										loginDialog = new AlertDialog.Builder(MainPrivacy.this).setView(loginView).create();
									}
									loginDialog.show();
