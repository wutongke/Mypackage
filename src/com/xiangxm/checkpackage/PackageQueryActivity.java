...
public class PackageQueryActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView();
		Common.closeWhenOncreate(PackageQueryActivity.this);// 进入界面关闭软键盘
	...
	public void initView() {
		...
		if (!Common.onlineFlag(PackageQueryActivity.this)) {
		...
		if (v.getId() == R.id.searchbtn) {
			...
			if (TextUtils.isEmpty(companynameTxt.getText())) {
				...
				Animation shakeAnim = AnimationUtils.loadAnimation(
						PackageQueryActivity.this, R.anim.shake_x);
				this.companynameTxt.startAnimation(shakeAnim);

				Toast.makeText(PackageQueryActivity.this, "您还未选择快递公司!",
				...
				Toast.makeText(PackageQueryActivity.this, "您还未输入订单号!",
						Toast.LENGTH_SHORT).show();
				return;
			}
			...
			if (!m.matches()) {
				Toast.makeText(PackageQueryActivity.this, "您的订单号不符合标准，请检查!",
						Toast.LENGTH_SHORT).show();
				return;
			}
			...
			intent = new Intent();
			intent.setClass(PackageQueryActivity.this, SelectCompanyActivity.class);
			...
			if (bol) {
				// 可伸缩的listview
				intent = new Intent();
				intent.setClass(PackageQueryActivity.this,
						CheckPackageHisActivity.class);
				overridePendingTransition(R.anim.slide_left, R.anim.slide_right);
				startActivity(intent);
			} else {

				Toast.makeText(PackageQueryActivity.this, "暂无历史记录!", Toast.LENGTH_SHORT)
						.show();
			}
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case FINISHED:
				...
				Common.closeKeyboardCommAct(PackageQueryActivity.this);// 关闭键盘
				break;
			...
			case 10:
				...
				Toast.makeText(PackageQueryActivity.this, "未获取到相关信息，请验证查询条件!",
						Toast.LENGTH_SHORT).show();
				break;
			}
	...
	class MyThread extends Thread {
		...
		public void run() {
			...
			intent.setClass(PackageQueryActivity.this, PackageDetailInfoActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == 8 && requestCode == 6) {
			...
			if (bundle == null) {
				...
				Toast.makeText(PackageQueryActivity.this, "获取数据失败!", Toast.LENGTH_SHORT)
						.show();
				return;
			}
